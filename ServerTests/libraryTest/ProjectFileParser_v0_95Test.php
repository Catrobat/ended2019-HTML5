...
require_once("Server/rest/v0.1/library/ProjectFileParser_v0_95.class.php");

class ProjectFileParser_v0_95Test extends PHPUnit_Framework_TestCase
{
  public $id = 0;
  ...
  public function testWhenProgramStartedBrick()
  {
    ...
    $parser = new ProjectFileParser_v0_95($projectId, $resBaseUrl, $cache, $simpleXML);
