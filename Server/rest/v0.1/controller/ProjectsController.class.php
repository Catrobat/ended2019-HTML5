...
class ProjectsController extends BaseController
{
  ...
  public function __construct($request)
  {
    ...
    {
      // is localhost
      $local_path = str_replace("rest\\v0.1", "", getcwd());
      $this->SERVER_ROOT = $local_path;
      //$this->SERVER_ROOT = "J:/Dropbox/_Uni/_6. Semester/Bakk/HTML5/Server/";
    }
  }
      ...
      else
      {
        switch($fileVersion)
        {
          case 0.93:
            ...
            break;
          case 0.94:
            $parser = new ProjectFileParser_v0_95($projectId, $resourceRoot, $cacheDir, $xml);
            break;
          case 0.95:
            $parser = new ProjectFileParser_v0_95($projectId, $resourceRoot, $cacheDir, $xml);
            break;
