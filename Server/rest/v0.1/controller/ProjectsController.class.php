  ...
  private function getProject($projectId)
  {
    ...
    {   //unzip even on $projectChanged == false to ensure file system integrity
      ...
      foreach($files as $file)
      {
        ...
        {  // && $_SERVER["SERVER_NAME"] !== $projectHost
      ...
      $resourceRoot
        = $protocol . "://" . $_SERVER["SERVER_NAME"] . "/html5/projects/" . $this->request->serviceVersion . "/"
          . $projectId . "/";
    ...
    {    //load pre-created project
      //load from cache
      $filePath
        =
        $cacheDir . "code.cache";           //TODO: if ($this->request->dataUrls) -> load cached? mp3 and media formats?
