    ...
    */
    ...
    PlayerToolbar: (function () {
        ...
        function PlayerToolbar(settings) {
            ...
            //buttons
            // i18n-button: back
            // this._backButton = new PocketCode.Ui.PlayerSvgButton(PocketCode.Ui.SvgImageString.BACK, PocketCode.I18nProvider.getDict().constant.back);
