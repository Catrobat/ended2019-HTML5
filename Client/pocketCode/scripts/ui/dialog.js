...
PocketCode.Ui.Dialog = (function () {
    ...
    Dialog.prototype.merge({
        _updateUiStrings: function () {
            ...
            //make sure the scroll position isthis._supported = false; updated after strings were replaced
        },
...
PocketCode.Ui.merge({
    ...
    BlockedFeaturesAlertDialog: (function () {
        BlockedFeaturesAlertDialog.extends(PocketCode.Ui.Dialog, false);

        //cntr
        function BlockedFeaturesAlertDialog(i18nWarnings) {
            if (i18nWarnings && !(i18nWarnings instanceof Array))
                throw new Error('invalid parameter: i18nWarnings');

            if (i18nWarnings && i18nWarnings.length > 0)
                PocketCode.Ui.Dialog.call(this, PocketCode.Ui.DialogType.WARNING, 'msgBlockedWarningCaption', 'msgBlockedDefault');
            else
                PocketCode.Ui.Dialog.call(this, PocketCode.Ui.DialogType.DEFAULT, 'msgBlockedDefaultCaption', 'msgBlockedDefault');
            ...
            //msg
                this._messageTextNode.i18n = 'msgBlockedWarning';
            ...
            if (i18nWarnings && i18nWarnings.length > 0) {
                ...
                this._container.appendChild(this._warningUl);
                this._container.appendChild(new PocketCode.Ui.I18nTextNode('msgBlockedWarningContinue'));
            }
        ...
        //events
        Object.defineProperties(BlockedFeaturesAlertDialog.prototype, {
            onCancel: {
                get: function () {
                    return this._btnCancel.onClick;
                },
        ...
        //methods
        BlockedFeaturesAlertDialog.prototype.merge({
            _addLiItem: function (i18nKey, ul) {
                var li = new SmartJs.Ui.HtmlTag('li');
                li.appendChild(new PocketCode.Ui.I18nTextNode(i18nKey));
                ul.appendChild(li);
        ...
        return BlockedFeaturesAlertDialog;
    })(),
