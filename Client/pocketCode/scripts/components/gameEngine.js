...
PocketCode.GameEngine = (function () {
    ...
    GameEngine.prototype.merge({
        ...
        loadProject: function (jsonProject) {
            ...
            this._spriteFactory = new PocketCode.SpriteFactory(this._device, this, this._broadcastMgr, this._soundManager, bricksCount, this._minLoopCycleTime, this._collisionManager);
