...
PocketCode.websiteUrl = PocketCode.domain + 'pocketcode/codeView';
    ...
    CodeInterface: new ((function () {
        ...
        CodeInterface.prototype = {
            ...
            _initApplication: function (mobileInitialized) {
                ...
                this._code = new PocketCode.CodeView.Application(vpc, this._rfc3066, mobileInitialized);
                this._code.onInit.addEventListener(new SmartJs.Event.EventListener(this._applicationInitHandler, this));
                this._code.onUiDirectionChange.addEventListener(new SmartJs.Event.EventListener(this._uiDirectionChangeHandler, this));
                this._code.onExit.addEventListener(new SmartJs.Event.EventListener(this._closeHandler, this));

                if (this._isMobile) {
                    //this._code = new PocketCode.Player.Application();//this._splashScreen, this._webOverlay);
                    //this._code.onInit.addEventListener(new SmartJs.Event.EventListener(this._applicationInitHandler, this));
                    this._code.onMobileInitRequired.addEventListener(new SmartJs.Event.EventListener(this._reinitMobileHandler, this));
                    //this._code.onExit.addEventListener(new SmartJs.Event.EventListener(this._closeHandler, this));
                    //this._code.loadProject(this._projectId);
                    ...
                    //var vpc = this._webOverlay ? this._webOverlay.viewportContainer : undefined;
                    //this._code = new PocketCode.Player.Application(vpc, this._rfc3066);
                    //this._code.onInit.addEventListener(new SmartJs.Event.EventListener(this._applicationInitHandler, this));
                    this._code.onHWRatioChange.addEventListener(new SmartJs.Event.EventListener(this._applicationRatioChangetHandler, this));
                    //this._code.onExit.addEventListener(new SmartJs.Event.EventListener(this._closeHandler, this));
                    //this._code.loadProject(this._projectId);
                }
                this._code.loadProject(this._projectId);
            ...
            _reinitMobileHandler: function (e) {
                ...
                //this._code = new PocketCode.Player.Application(undefined, undefined, true);
                //this._code.onInit.addEventListener(new SmartJs.Event.EventListener(this._applicationInitHandler, this));
                //this._code.loadProject(this._projectId);
            },
            ...
            _muteHandler: function (e) {
                ...
                btn.blur();
                var muted = this._code.toggleMuteSounds();
                if (muted)  //true
                    btn.className += ' pc-webButtonChecked ';
                else
                    btn.className = btn.className.replace(' pc-webButtonChecked ', '').trim();
            ...
            _keyHandler: function (e) {
                if (!this._redirected && e.keyCode == 27 && (!this._code || (this._code && !this._code.hasOpenDialogs))) {
            ...
            _closeHandler: function (e) {
                ...
                if (this._code) {  //handle close before initialize
                    try {
                        this._code.onInit.removeEventListener(new SmartJs.Event.EventListener(this._applicationInitHandler, this));
                        this._code.onUiDirectionChange.removeEventListener(new SmartJs.Event.EventListener(this._uiDirectionChangeHandler, this));
                        this._code.onHWRatioChange.removeEventListener(new SmartJs.Event.EventListener(this._applicationRatioChangetHandler, this));
                        this._code.onExit.removeEventListener(new SmartJs.Event.EventListener(this._closeHandler, this));
                        this._code.dispose();
...
PocketCode.Web.resources = {
    ...
    files: [
		...
		{ url: 'pocketCode/scripts/view/codePageView.js', type: 'js' },
		{ url: 'pocketCode/scripts/view/codeViewportView.js', type: 'js' },

		{ url: 'pocketCode/scripts/controller/controllerCore.js', type: 'js' },
		{ url: 'pocketCode/scripts/controller/codePageController.js', type: 'js' },
		{ url: 'pocketCode/scripts/controller/codeViewportController.js', type: 'js' },

		//TODO: insert player scripts
		{ url: 'codeview/scripts/codeApplication.js', type: 'js' },
    ],
};
