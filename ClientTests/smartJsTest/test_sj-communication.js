...
QUnit.test("SmartJs.Communication: Cors", function (assert) {
	...
	var onLoadStartHandler = function (e) {
		onLoadStart++;
		//validate request url
		assert.equal(req._url, "https://web-test.catrob.at/html5/rest/v0.4/projects/824/details?a=eins&b=2", "valid  request url params: GET");
		assert.equal(e.target, req, "onLoadStart target check");
		//console.log('onLoadStart ');
	};
	var onLoadStartHandler2 = function (e) {
	...
	var onErrorHandler = function (e) {
		assert.ok(false, "WARNING: cors call to https://web-test.catrob.at/html5/rest/v0.4/projects/824/details failed - this may be an error caused by the server");
		done1();
	...
	req = new SmartJs.Communication.CorsRequest("https://web-test.catrob.at/html5/rest/v0.4/projects/824/details");  //public service
	...
	var runTest4 = function () {
		...
		req4 = new SmartJs.Communication.CorsRequest();//"https://web-test.catrob.at/html5/rest/v0.4/projects/825");
		...
		req4.send(SmartJs.RequestMethod.GET, "https://web-test.catrob.at/html5/rest/v0.4/projects/825");
	};



	//start async
	req.sendData({ a: "eins", b: 2 }, SmartJs.RequestMethod.GET, "https://web-test.catrob.at/html5/rest/v0.4/projects/824/details"); //start async requests 
