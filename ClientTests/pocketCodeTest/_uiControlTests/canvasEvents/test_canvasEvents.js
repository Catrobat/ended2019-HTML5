...
function imagesLoadHandler() {
    ...
    var sprite1 = new PocketCode.Model.Sprite(gameEngine, scene, 20, { id: "id0", name: "sprite0", looks: looks1 });   //(0/0)
    var sprite2 = new PocketCode.Model.Sprite(gameEngine, scene, 20, { id: "id1", name: "sprite1", looks: looks2 });
    sprite2.setPosition(40, 30);
    var sprite3 = new PocketCode.Model.Sprite(gameEngine, scene, 20, { id: "id2", name: "sprite2", looks: looks1 });
    sprite3.setPosition(10, -40);
    var sprite4 = new PocketCode.Model.Sprite(gameEngine, scene, 20, { id: "id3", name: "sprite3", looks: looks2 });
