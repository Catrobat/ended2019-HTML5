...
QUnit.test("*", function (assert) {
    ...
    var client_known_errors = {
        ...
        //6038: "timeout 120s",
        //3406: "timeout 120s",
        2578: "timeout 120s, invalid project stops loading after 816 out of 820 bricks",
        //873: "sound issue", //sound resolved but: start and/or end: expected type: object { x: [number], y: [number] }
        //957: "?",
        3284: "timeout 120s, large project: loading works but may take a while",
        //2733: "timeout 120s",
        //1868: "timeout 120s",
        //3469: "timeout 120s",
        ...
        5286: "timeout 120s, project not valid",
        ...
        //2689: "timeout 120s",
        3240: "timeout 120s, large project: loading works but may take a while",
