...
QUnit.module("Test 10 recent and 2 own projects - FULL + use known error lists");
...
QUnit.test("projectTesterClass", function (assert) {
  ...
  var server_known_errors = {
    ...
    4: "image file '41f124e7ed37b3dac8ccaeb17b2156b8_birdyellow1.PNG' does not exist",
    11: "image file '13391b464c32bdc716193cb84c960fab_embed (2).png' does not exist"
  };
  ...
  var test = new PocketCode.ProjectTesterClass(server_known_errors, client_known_errors, known_invalid_projects);
