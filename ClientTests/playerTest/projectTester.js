...
PocketCode.ProjectTesterClass = (function () {
  ...
  function ProjectTesterClass() {
    ...
    this._server_known_errors = {
      782 : "ForeverBrick: missing LoopEndlessBrick",
      821 : "ForeverBrick: missing LoopEndlessBrick",
      962 : "ForeverBrick: missing LoopEndlessBrick",
      1791 : "ForeverBrick: missing LoopEndlessBrick",
      1792 : "ForeverBrick: missing LoopEndlessBrick",
      1793 : "ForeverBrick: missing LoopEndlessBrick",
      1797 : "ForeverBrick: missing LoopEndlessBrick",
      1801 : "ForeverBrick: missing LoopEndlessBrick",
      1802 : "ForeverBrick: missing LoopEndlessBrick",
      1804 : "ForeverBrick: missing LoopEndlessBrick",
      1805 : "ForeverBrick: missing LoopEndlessBrick",
      1806 : "ForeverBrick: missing LoopEndlessBrick",
      1808 : "ForeverBrick: missing LoopEndlessBrick",
  ...
  Object.defineProperties(ProjectTesterClass.prototype, {
    ...
    timeout: {
      ...
      set: function (value) {
        if (typeof value !== 'number' || value % 1 != 0)
          throw new Error('invalid parameter: expected type \'number\'');
        this._timeout_time = value;
      }
    },
    testServerListedPrograms: {
      get: function () {
        return this._test_only_listed_programs;
      },
      set: function () {
        this._test_only_listed_programs = "server";
      }
    },
    testClientListedPrograms: {
      get: function () {
        return this._test_only_listed_programs;
      },
      set: function () {
        this._test_only_listed_programs = "client";
      }
    },
    testAllButListedPrograms: {
      get: function () {
        return this._test_only_listed_programs;
      },
      set: function () {
